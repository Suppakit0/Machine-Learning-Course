...
# ใช้โหมด "Agg" เพื่อบอกให้ Matplotlib สร้างและเซฟกราฟเป็นไฟล์รูปภาพ (Backend) 
# โดยไม่ต้องพยายามเปิดหน้าต่างกราฟิก (GUI) ขึ้นมาแสดงผล ซึ่งเหมาะกับการรันบนเซิร์ฟเวอร์หรือทำสคริปต์อัตโนมัติ
matplotlib.use("Agg")
