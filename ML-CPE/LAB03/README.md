...
1. LAB 1: Regression Performance (Age Prediction)
...
2. LAB 2: Classification Metrics & Decision Boundaries (Gender Prediction)
...
3. LAB 3: Model Comparison & Overfitting Evaluation
